...
__global__ void
approxmatch_kernel(int b, int n, int m, const scalar_t *__restrict__ xyz1,
...
template <typename scalar_t>
__global__ void matchcost_kernel(int b, int n, int m,
...
template <typename scalar_t>
__global__ void matchcostgrad2_kernel(int b, int n, int m,
...
template <typename scalar_t>
__global__ void matchcostgrad1_kernel(int b, int n, int m,
                                      const scalar_t *__restrict__ grad_cost,
                                      const scalar_t *__restrict__ xyz1,
                                      const scalar_t *__restrict__ xyz2,
                                      const scalar_t *__restrict__ match,
